    ...
    public class PersonagensController : ApiController
    {
        ...
        public HttpResponseMessage Get(int id)
        {
            using (var entities = new PersonagensEntities())
            {
                ...
                {
                    return Request.CreateErrorResponse(HttpStatusCode.NotFound, $"Personagem com o id: {id} não foi encontrado");
                }
            }
        }
        ...
        public HttpResponseMessage Delete(int id)
        {
            try
            {
                using (var entities = new PersonagensEntities())
                {
                    ...
                    if (entity == null)
                    {
                        return Request.CreateErrorResponse(HttpStatusCode.NotFound, $"O personagem com o id: {entity.ID} não foi encontrado!");
                    }
                    else
                    {
