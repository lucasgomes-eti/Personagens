...
using PersonagensApp;
using Xamarin.Forms;
using Xamarin.Forms.Platform.Android;
using PersonagensApp.Droid;
using Android.Support.Design.Widget;
using PersonagensApp.Droid.Renderers;
...
namespace PersonagensApp.Droid.Renderers
{
    public class FloatingActionButtonViewRenderer : ViewRenderer<FloatingActionButtonView, FrameLayout>
    {
        ...
        public FloatingActionButtonViewRenderer()
        {
            ...
            fab = new com.refractored.fab.FloatingActionButton(context);
